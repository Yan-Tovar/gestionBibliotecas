...
<body>
    ...
    <div class="container-fluid">
        ...
        <br>
        <?php
            if(isset($allAuthorResult) && $allAuthorResult->num_rows > 0){
        ?>
            <ol class="list-group list-group-numbered">
                <div class="row">
                    <h6>Listado de Autores</h6>
            <?php
                ...
                <!-- Este es el modelo de presentación para cada Autor -->
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <li class="list-group-item d-flex justify-content-between align-items-start">
                            ...
                            <form action="authorDestroy" method="POST">
                                <input type="hidden" value="<?php echo $fila->id; ?>" name="id">
                                <button type="submit" class="btn-border-none" onclick="return confirm('¿Seguro que deseas eliminar este Author?');"><i class="material-icons">delete</i></button>
                            </form>
                        </li>
                        <br>
                    </div>
        ...
        <div class="modal fade" id="createAuthor" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="createAuthorLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="createAuthorLabel">Agregar Author</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form action="authorStore" method="POST">
                            <div class="mb-3">
